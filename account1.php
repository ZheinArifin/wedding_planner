        ...
        <section class="inner-page">
            ...
            <div class="container" id="tab_produk">
                ...
                <table class='table table-striped'>
                    ...
                    <tbody>
                    <?php
                    $sql = mysqli_query($con, "SELECT * FROM pembayaran WHERE id_pelanggan='$_SESSION[id_pel]' AND status = 'Belum Bayar'");
                    $no =1;
                    while ($row = mysqli_fetch_array($sql)) {
                ...
                <table class='table table-striped'>
                    ...
                    <tbody>
                    <?php
                    $sql = mysqli_query($con, "SELECT * FROM pembayaran WHERE id_pelanggan='$_SESSION[id_pel]' AND (status = 'Lunas' OR status = 'Dibayar') ");
                    $no =1;
                    while ($row = mysqli_fetch_array($sql)) {
                        $sql_3 = "SELECT * FROM penyewaan WHERE id='$row[id_penyewaan]'";
                        ...
                        $sql_4 = "SELECT * FROM diskon WHERE id_katalog='$row[id_katalog]'";
                        $query_4 = $con -> query($sql_4);
                        $dskn = $query_4 -> fetch_array(MYSQLI_ASSOC);

                        $ttl = $produk['harga'] - ($dskn['diskon'] * $produk['harga']);
