					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right">
							...
							if ($_SESSION['id_pel'] != "") {
								...
								$login = "<a href='index' data-toggle='modal' data-target='#login'><i class='fas fa-sign-in-alt'></i></a>";
							}
							?>
							<li><?= $login; ?></li>
						</ul>
	...
	<div class="gallery">
		<div class="container">
			...
			<div class="gallery-grids">
				<?php
				$sql =  mysqli_query($con, "SELECT gallery.*, katalog_produk.* FROM gallery INNER JOIN katalog_produk ON gallery.id_katalog = katalog_produk.id");
					...
					<div class="col-md-4 gallery-grid">
						<div class="grid">
							<figure class="effect-apollo">
								<a class="example-image-link" href="Admin/assets/img/gallery/<?=$dt?>" data-lightbox="example-set" >
									<img src="Admin/assets/img/gallery/<?=$dt?>" alt=""  />
									<figcaption>
										<p><?=$row['katalog_produk']?></p>
									</figcaption>	
								</a>
							</figure>
						</div>
