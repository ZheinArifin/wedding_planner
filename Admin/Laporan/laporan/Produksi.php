...
// mencetak string 
$pdf->Cell(226,7,'Laporan Data Produksi Ramayana Print ',0,1,'C');
...
include '../koneksi.php';
$sql = mysql_query("SELECT * FROM produksi  WHERE  YEAR(tgl_produksi) = '$_POST[tahun]' ORDER BY tgl_produksi ASC");
 // AND  status_produksi !='Selesai Di Produksi'
$no=1;
