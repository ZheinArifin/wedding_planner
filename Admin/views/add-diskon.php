      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Tambah Diskon</a>
          </div>
            ...
            <div class="col-md-12">
              ...
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Diskon Produk</h4>
                </div>
                <div class="card-body">
                    ...
                    <form method="post" class="pl-5 pr-5" enctype="multipart/form-data" >
                      <div class="row">
                          <div class="col-md-6 col-sm-12">
                              <input type="text" name="nama_diskon" required autocomplete class="form-control" placeholder="Nama Diskon">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                            <select name="katalog_produk[]" id="produk" required class="form-control" style="background-color:rgba(32,41,64,1)" multiple>
                              <option value="" >-- Pilih Katalog Produk --</option>
                              <?php 
                                $sql = mysqli_query($con,"SELECT * FROM katalog_produk");
                                while($row = mysqli_fetch_array($sql)){
                                  echo "<option vlaue='$row[id]'>$row[katalog_produk]</option>";
                                }
                              ?>
                            </select>
                          </div>
                      ...
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <input type="number" name="diskon" placeholder="Diskon" min="1" max="100" class="form-control" onkeypress="return /[0-9]/i.test(event.key)">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <textarea  name="ket" placeholder="Ket Diskon" class="form-control"></textarea>
                          </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mt-2">
                          <a href="diskon.php" class="btn btn-danger btn-round form-control">Kembali</a>
                        </div>
                      </div>
                    </form>
...
class send_mail {
  function send(){
    ...
    while ($rows = mysqli_fetch_array($Query)) {
      array_push($dt_email, $rows['email']);
    }
    // send mail
    ...
    // alamat gmail kamu
    $mail->Username = 'susimakeup60@gmail.com';

    // password Anda harus disertakan dalam tanda kutip tunggal
    $mail->Password = 'kuningan2021';

    // tambahkan 
    $mail->Subject = ' New Diskon ';
    
    // alamat email pengirim dan nama
    $mail->SetFrom('susimakeup60@gmail.com', 'Susie Make Up');
    foreach ($dt_email as $val) {
    ...
    $message = "
      ...
      .footer a, .footer a:hover {
        ...
        <title>Mengirim email dari localhost/server online menggunakan php</title>
          ...
          <table border='0' cellpadding='0' cellspacing='0' align='center'
            ...
            <tr>
              <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
                ...
                href='http://localhost//Wedding-Planner/'>
                <img border='0' vspace='0' hspace='0'
                src='https://storage.googleapis.com/ares-profile-pictures/hd/susie_make_up_-9393ab9656868280e839b66321f6e756_hd.jpg'
            ...
            <tr>
              <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 17px; font-weight: 400; line-height: 160%;
                ...
                font-family: sans-serif;' class='paragraph'>
                  Ada diskon, untuk paket - paket tertentu, buruan cek website kami di <a target='_blank' style='text-decoration: none;'
                  href='http://localhost//Wedding-Planner/'><b>Susie Make Up</b></a>
              </td>
            </tr>
            ...
            <tr>
              <td align='center' valign='top' style='border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 13px; font-weight: 400; line-height: 150%;
                ...
                font-family: sans-serif;' class='footer'>
                  ...
                  Email ini dikirim otomati oleh sistem. Anda tidak perlu membalas email ini.
...
if(isset($_POST['simpan'])){
  $kd = mysqli_fetch_array(mysqli_query($con, "SELECT MAX(id) as x FROM diskon"));
  $id =$kd['x'];
  $id++;
  $id_katalog = implode(",", $_POST['katalog_produk']);
  
  $sql = mysqli_query($con, "INSERT INTO diskon VALUES('$id','$id_katalog','$_POST[nama_diskon]','$_POST[ket]','$_POST[diskon]')");
  ...
  if($sql){
    ...
    ?>
      <script>
        ...
        alert.innerHTML="Maaf, Terjadi kesalahan saat mencoba untuk menyimpan data ke dalam sistem. <?= mysqli_error($con); ?>";
      </script>
    <?php
  }
