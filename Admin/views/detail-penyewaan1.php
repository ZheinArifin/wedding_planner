                            ...
                            <div class="col-lg-6">
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        ...
                                        <input type="text" style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;" class="form-control" value="<?= $pel['nama']; ?>" disabled style="border: 0px solid green; background:black; box-shadow: 0 0 3px aqua">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        <small>Katalog Produk</small>
                                        <input type="text"  class="form-control" value="<?= $prod['katalog_produk']; ?>" disabled style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        ...
                                        <hr style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                                ...
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        ...
                                        <input type="text"  class="form-control" value="<?= date("d F Y", strtotime($dt['tgl_sewa'])); ?>" disabled style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        <small>Harga</small>
                                        <input type="text"  class="form-control" value="Rp. <?=number_format($prod['harga'],0,'.','.'); ?>" disabled style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        <small>Diskon</small>
                                        <input type="text"  class="form-control" value="Rp. <?=number_format($diskon,0,'.','.'); ?>" disabled style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-lg-12" >
                                        <small>Total</small>
                                        <input type="text"  class="form-control" value="Rp. <?=number_format($total,0,'.','.'); ?>" disabled style="background-color:rgba(0,0,0,0);  border-bottom: 1px solid black;">
                                    </div>
                                </div>
                                <?php
