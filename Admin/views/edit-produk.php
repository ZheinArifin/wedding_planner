<?php 
include 'koneksi.php';
$data = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM katalog_produk WHERE id='$_GET[id]'"))
?>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <form method="post" class="pl-5 pr-5" enctype="multipart/form-data" >
                      <div class="row">
                          <div class="col-md-6 col-sm-12">
                              <input type="text" name="katalog_produk" required autocomplete="off" class="form-control" placeholder="Katalog Produk" value="<?=$data['katalog_produk'];?>">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-12 col-sm-12 mt-3">
                              <label>Deskripsi Produk</label>
                              <textarea name="deskripsi_produk" placeholder="Deskripsi Produk" class="form-control" rows="3" required><?=$data['deskripsi'];?></textarea>
                              <script>
                      ...
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <input type="text" name="harga" minlength="5" placeholder="harga" class="form-control" required autocomplete="off" onkeypress="return /[0-9]/i.test(event.key)" value="<?=$data['harga'];?>">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <input type="number" name="stok" placeholder="stok" min="1" class="form-control" required autocomplete="off" onkeypress="return /[0-9]/i.test(event.key)" value="<?=$data['stok'];?>">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <input type="file" name="gambar" placeholder="gambar" accept="image/*" class="form-control" >
                          </div>
                      </div>
                      <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12 mt-2">
                          <a href="produk.php" class="btn btn-danger form-control">Kembali</a>
                        </div>
                      </div>
                    </form>
  ...
  if($ukuran_file <= 2000000){
    ...
    if($nama_file != ""){
        if(move_uploaded_file($tmp_file, $path)){
            $sql = mysqli_query($con, "UPDATE katalog_produk SET katalog_produk='$_POST[katalog_produk]', deskripsi='$_POST[deskripsi_produk]', harga='$_POST[harga]', stok='$_POST[stok]', gambar='$nama_file' WHERE id='$_GET[id]'");
        }else{
          ?>
            <script>
      ...
      if($sql){
        ...
        $sql = mysqli_query($con, "UPDATE katalog_produk SET katalog_produk='$_POST[katalog_produk]', deskripsi='$_POST[deskripsi_produk]', harga='$_POST[harga]', stok='$_POST[stok]' WHERE id='$_GET[id]'");
        if($sql){
            ?>
              <script>
                var alert = document.getElementById('alert-success');
