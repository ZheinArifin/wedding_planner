            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h4 class="card-title ">Tabel Penyewaan</h4>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table">
                      ...
                      <tbody>
                        <?php 
                        $no=1;
                        $sql = mysqli_query($con, "SELECT * FROM penyewaan  ORDER BY tgl_sewa");
                        ...
                        ?>
                          <tr>
                            ...
                            <td style="width:200px">
                              <span style="padding:10px; background-color:<?=$clr?>; color:white; border-radius:50px"><?= date('d F Y', strtotime($row['tgl_sewa']));?></span>
                            </td>
                            <td>
                              <?=$prd['katalog_produk'];?>
                            </td>
                            ...
                            <td style="width:100px">
                                <a href="detail-penyewaan.php?id=<?=$row['id'];?>" style="padding:10px; background-color:orange; border-radius:50px">
