                  ...
                  <div class="table-responsive">
                    <table class="table" id="myTable" >
                      ...
                      <tbody >
                        <?php 
                        $no=1;
                        $sql = mysqli_query($con, "SELECT * FROM pembayaran  ORDER BY tgl_bayar");
                        while($row = mysqli_fetch_array($sql)){
                            $pel = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM pelanggan WHERE id='$row[id_pelanggan]'"));
                            $sewa = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM penyewaan WHERE id='$row[id_penyewaan]'"));
                        ...
                        ?>
                          <tr style="background-color:rgba(0,0,0,0)">
                            ...
                            <td>
                              <span style="padding:10px; background-color:blue; color:white; border-radius:50px"><?= date('d F Y', strtotime($row['tgl_bayar']));?></span>
                            </td>
                            <td>
                              <?=$prd['katalog_produk'];?>
                            </td>
                            ...
                            <td>
                                <a href="detail-pembayaran.php?id=<?=$row['id'];?>" style="padding:10px; background-color:orange; border-radius:50px">
