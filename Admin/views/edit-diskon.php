<?php 
include 'koneksi.php';
$data = mysqli_fetch_array(mysqli_query($con, "SELECT * FROM diskon WHERE id='$_GET[id]'"))
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:void(0)">Edit Diskon</a>
          </div>
                    ...
                    <form method="post" class="pl-5 pr-5" enctype="multipart/form-data" >
                      <div class="row">
                          <div class="col-md-6 col-sm-12">
                              <input type="text" name="nama_diskon" value="<?=$data['nama_diskon'];?>" required autocomplete class="form-control" placeholder="Nama Diskon">
                          </div>
                      </div>
                      <div class="row">
                            ...
                            <select name="katalog_produk[]" id="produk" required class="form-control" style="background-color:rgba(32,41,64,1)" multiple>
                              <?php 
                                ...
                                while($row = mysqli_fetch_array($sql)){
                                    $id_klg = explode(",", $data['id_katalog']);
                                        if($id_klg[$i] == $row['id']){
                                            echo "<option selected value='$row[id]'>$row[katalog_produk]</option>";
                                        }else{
                      ...
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <input type="number" name="diskon" placeholder="Diskon" min="1" max="100" class="form-control" onkeypress="return /[0-9]/i.test(event.key)" value="<?=$data['diskon'];?>">
                          </div>
                      </div>
                      <div class="row">
                          <div class="col-md-6 col-sm-12 mt-3">
                              <textarea  name="ket" placeholder="Ket Diskon" class="form-control"><?=$data['ket'];?></textarea>
                          </div>
                      </div>
                      <div class="row">
...
if(isset($_POST['simpan'])){
  ...
  $sql = mysqli_query($con, "UPDATE diskon SET id_katalog = '$id_katalog', nama_diskon='$_POST[nama_diskon]', ket='$_POST[ket]', diskon='$_POST[diskon]' WHERE id='$_GET[id]'");
