            ...
            <div class="card" style="box-shadow: 0 4px 8px 0 rgba(0,0,0,0.3); color: black;">
                ...
                <div class="card-body">
                    ...
                    <div style="padding: 10px 20px;">
                        <div class="row">
                            <div class="col-lg-5">
                                <small class="text-gray-700" style="color:white; font-weight:bold">
                                    Tagihan
                                </small><br>
                            ...
                            <div class="col-lg-4" style="color:white; font-weight:bold">
                            ...
                            <div class="col-lg-3" style="text-align:right;">
                                ...
                                <label>
                                  ...
                                  if($dt['bukti'] != "" && $dt['bukti_lunas'] == ""){
                                      ?>
                                      Rp. <?=number_format(( $diskon_ttl - $dDp ),'0','.','.');?> 
                                      <?php
                                  }else{
                                      ?>
                                    ...
                                    if($dt['bukti'] != "" && $dt['bukti_lunas'] != "" && $status == "Sedang Diproses"){
                                      ?>
                                      <h3>Rp. <?= number_format($dp,0,'.','.'); ?></h3>
                                      <?php
                                    }elseif($dt['bukti'] != "" && $dt['bukti_lunas'] == ""){
                                      ?>
                                      <h3>Rp. <?= number_format(($diskon_ttl - $dp),0,'.','.'); ?></h3>
                                      <?php
                                    }elseif($dt['bukti'] != "" && $dt['bukti_lunas'] != "" && $status == "Lunas"){
                                      ?>
                                      <h3>Rp. <?= number_format($diskon_ttl,0,'.','.'); ?></h3>
                                      <?php
                                    }
                                  ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2">
                                ...
                                if($dt['bukti'] != "" && $dt['bukti_lunas'] != "" && $status == "Sedang Diproses"){
                                  ?>
                                  <b>Rp. <?= number_format($dp,0,'.','.'); ?></b><br>
                                  <?php
                                  echo "Sisa Pembayaran<br>";
                                }elseif($dt['bukti'] != "" && $dt['bukti_lunas'] == ""){
                                  ?>
                                  <b>Rp. <?= number_format(($diskon_ttl - $dp),0,'.','.'); ?></b><br>
                                  <?php
                                  echo "Uang Muka<br>";
                                }elseif($dt['bukti'] != "" && $dt['bukti_lunas'] != "" && $status == "Lunas"){
                                  ?>
                                  <b>Rp. <?= number_format($diskon_ttl,0,'.','.'); ?></b><br>
                                  <?php
                                  echo "Lunas<br>";
                                }
                                ?>
                            ...
                            <div class="row">
                              ...
                              ?>
                                <div class="col-lg-12 mb-3">
                                    <center>
                                        <div >
                                            <img src="../assets/img/Bukti/<?=$dt['bukti_lunas'];?>" style="padding:10px 10px; border:0.1px solid black; background: rgba(0, 0, 0, 0.1);" class="col-lg-5">
                                        </div>
                                    </center>
                                </div>
                              <?php
...
if (isset($_POST['valid'])) {
  ...
  if($dt['bukti_lunas'] != ""){
    $sql1 = mysqli_query($con, "UPDATE pembayaran SET status ='Lunas' WHERE id='$_GET[id]'");
    $sql2 = mysqli_query($con, "UPDATE penyewaan SET status ='Lunas' WHERE id='$dt[id_penyewaan]'");
  }else{
